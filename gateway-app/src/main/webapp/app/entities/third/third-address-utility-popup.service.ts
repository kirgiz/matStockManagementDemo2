...
@Injectable()
export class ThirdAddressUtilityPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.thirdModalRef(component, new ThirdAddressUtility());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    thirdModalRef(component: Component, third: ThirdAddressUtility): NgbModalRef {
