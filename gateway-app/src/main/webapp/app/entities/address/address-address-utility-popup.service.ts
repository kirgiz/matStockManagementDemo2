...
@Injectable()
export class AddressAddressUtilityPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.addressModalRef(component, new AddressAddressUtility());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    addressModalRef(component: Component, address: AddressAddressUtility): NgbModalRef {
