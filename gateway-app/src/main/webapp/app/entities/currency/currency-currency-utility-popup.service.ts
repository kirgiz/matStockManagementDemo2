...
@Injectable()
export class CurrencyCurrencyUtilityPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.currencyModalRef(component, new CurrencyCurrencyUtility());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    currencyModalRef(component: Component, currency: CurrencyCurrencyUtility): NgbModalRef {
