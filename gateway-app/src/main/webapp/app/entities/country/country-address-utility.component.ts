...
@Component({
    selector: 'jhi-country-address-utility',
    templateUrl: './country-address-utility.component.html'
})
export class CountryAddressUtilityComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: CountryAddressUtility) {
        return item.id;
    }
