...
import com.addressandthirdmanagement.app.service.AddressService;
...
public class AddressResourceIntTest {
    ...
    private static final String DEFAULT_TYPE = "AAA";
    private static final String UPDATED_TYPE = "BBB";
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address()
            ...
            .type(DEFAULT_TYPE);
        // Add required entity
        AddressTypeDefinition addressTypeDefinition = AddressTypeDefinitionResourceIntTest.createEntity(em);
        em.persist(addressTypeDefinition);
        em.flush();
        address.setAddressTypeDefinition(addressTypeDefinition);
        // Add required entity
