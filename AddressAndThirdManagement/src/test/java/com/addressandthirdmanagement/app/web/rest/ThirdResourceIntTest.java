...
import com.addressandthirdmanagement.app.service.ThirdService;
...
public class ThirdResourceIntTest {
    ...
    public static Third createEntity(EntityManager em) {
        ...
        // Add required entity
        ThirdTypeDefinition thirdTypeDefinition = ThirdTypeDefinitionResourceIntTest.createEntity(em);
        em.persist(thirdTypeDefinition);
        em.flush();
        third.setThirdTypeDefinition(thirdTypeDefinition);
        return third;
    }
    ...
    public void createThird() throws Exception {
        ...
        assertThat(testThird.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    ...
    public void updateThird() throws Exception {
        ...
        assertThat(testThird.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
