...
class CountryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Country entity")
        ...
        .repeat(2) {
            ...
            .get("/addressandthirdmanagement/api/countries")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new country")
            .post("/addressandthirdmanagement/api/countries")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/addressandthirdmanagement${new_country_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created country")
            .delete("/addressandthirdmanagement${new_country_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
